...
class WxPayConf_pub
{
	...
	const APPSECRET = '27bec66d6eabb65dc637af562a17da46';
	
	//=======【JSAPI路径设置】===================================
	//获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
	const JS_API_CALL_URL = 'http://fqmall.tjtomato.com/clientapi/Wxpay/jsApiCall';
	...
	const NOTIFY_URL = 'http://fqmall.tjtomato.com/clientapi/Wxpay/notify';
