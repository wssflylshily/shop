...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录<?php echo C('WEB_SITE_TITLE');?>商城</title>
        ...
        <div id="main-content">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('Public/login');?>" method="post" class="login-form">
                        <h3 class="welcome"><i class="login-logo"></i><?php echo C('WEB_SITE_TITLE');?>商城管理平台</h3>
