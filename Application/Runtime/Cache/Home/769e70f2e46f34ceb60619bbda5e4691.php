		...
		<div id="indexMain" class="fastscroll">
			<div class="maxWidth">
				...
				<div class="com" id="beautiful">
					<div class="tit">
						<a href="/Home/Index/catelist/id/14"><img src="/Public/Home/img/index/index_tit1.jpg" /></a>
					</div>
					<div class="lunbo">
						<div class="swiper-container">
							<div class="swiper-wrapper">
				...
				<div class="com" id="health">
					<div class="tit">
						<a href="/Home/Index/catelist/id/16"><img src="/Public/Home/img/index/index_tit2.jpg" /></a>
					</div>
					<div class="lunbo">
						<div class="swiper-container">
							<div class="swiper-wrapper">
				...
				<div class="com" id="wanle">
					<div class="tit">
						<a href="/Home/Index/catelist/id/17"><img src="/Public/Home/img/index/index_tit3.jpg" /></a>
					</div>
					<div class="lunbo">
						<div class="swiper-container">
							<div class="swiper-wrapper">
				...
				<!-- <div class="com" id="jiaju">
					<div class="tit">
						<a href="/Home/Index/catelist/id/5"><img src="/Public/Home/img/index/index_tit4.jpg" /></a>
					</div>
					<div class="lunbo">
						<div class="swiper-container">
							<div class="swiper-wrapper">
