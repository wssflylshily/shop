    ...
    public function entry($id = '') {
        ...
        if($this->useZh){ // 中文验证码
            ...
            for ($i = 0; $i<$this->length; $i++) {
                ...
                $codeNX  += mt_rand($this->fontSize*1.0, $this->fontSize*1.2);
                imagettftext($this->_image, $this->fontSize, mt_rand(-30, 30), $codeNX, $this->fontSize*1.5, $this->_color, $this->fontttf, $code[$i]);
            }
        }
